...
router.get('/', async function (req, res) {
    await db.getallmed(function (err, result) {
        res.render('view_store.ejs', { list: result });
    })
});
...
// router.post('/add_med', async function (req, res) {
//     try {
...
//         await db.addMed(name, p_date, expire, e_date, price, quantity);
...
router.post('/add_med', async function (req, res) {
    ...
    await db.addMed(name, p_date, expire, e_date, price, quantity, function (err, result) {
        console.log("medicine Added");
